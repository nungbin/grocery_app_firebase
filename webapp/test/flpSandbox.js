		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Test Firebase",
									"targetURL": "#prjtestfirebase-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"prjtestfirebase-display": {
								"semanticObject": "prjtestfirebase",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=prjtestfirebase",
									"url": sap.ui.require.toUrl("prjtestfirebase")
								}
							}
						}
					}
